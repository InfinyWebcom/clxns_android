...
class UpdatedContactAdapter(private val dataList : List<UpdatedContactData>) :
    RecyclerView.Adapter<UpdatedContactAdapter.UpdatedContactVH>() {
    class UpdatedContactVH(itemView : ContactListItemBinding) :
